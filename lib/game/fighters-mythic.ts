...
export const MYTHIC_FIGHTERS: Fighter[] = [
  ...
  { id: "mythic_mcgregor", name: "Karate Stance McGregor", nickname: "Mystic Mac", division: "Lightweight", era: "2010s", isMythic: true, striking: 99, grappling: 72, cardio: 85, durability: 80, fightIq: 92, experience: 92, finishing: 97 },
  ...
  { id: "mythic_dlewis", name: "Balls Hot Lewis", nickname: "My Balls Was Hot", division: "Heavyweight", era: "Modern", isMythic: true, striking: 95, grappling: 56, cardio: 62, durability: 90, fightIq: 66, experience: 86, finishing: 99 },
  // Won the belt with one working eye. Cannot be finished, will not go away.
  { id: "mythic_bisping", name: "One Eye Bisping", nickname: "The Count", division: "Middleweight", era: "2010s", isMythic: true, striking: 95, grappling: 80, cardio: 93, durability: 99, fightIq: 90, experience: 98, finishing: 85 },
  ...
  { id: "mythic_oliveira", name: "Blonde Oliveira", nickname: "Do Bronx", division: "Lightweight", era: "Modern", isMythic: true, striking: 90, grappling: 98, cardio: 90, durability: 95, fightIq: 88, experience: 96, finishing: 99 },
  // Coasts two rounds. Then the third round starts and God help you.
  { id: "mythic_romero", name: "3rd Round Romero", nickname: "No Excuses", division: "Middleweight", era: "2010s", isMythic: true, striking: 94, grappling: 93, cardio: 70, durability: 99, fightIq: 80, experience: 86, finishing: 99 },
  // Three piece and a soda. Gamebred with nothing to lose.
  { id: "mythic_masvidal", name: "Backyard Masvidal", nickname: "Three Piece & a Soda", division: "Welterweight", era: "Modern", isMythic: true, striking: 97, grappling: 78, cardio: 84, durability: 90, fightIq: 82, experience: 95, finishing: 94 },
  // The timeline where the lifestyle never slowed him down. Terrifying.
  { id: "mythic_jones", name: "Cocaine Jones", nickname: "White", division: "Light Heavyweight", era: "Modern", isMythic: true, striking: 94, grappling: 97, cardio: 94, durability: 96, fightIq: 99, experience: 96, finishing: 92 },
